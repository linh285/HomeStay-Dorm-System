...
import { formatDate, checkoutStatusConfig } from '../utils/formatters';
...
export default function CheckoutRequest() {
  ...
  const fetchCheckouts = async () => {
    ...
    try {
      ...
      // Interceptor đã unwrap, res chính là object đó
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      // getContracts trả về { contracts: [...], total, page, limit }
            ...
            <div className="card">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div style={{ display: 'flex', gap: 8 }}>
                  ...
                  <Button type="button" variant="outline" onClick={() => { setFoundContract(null); setSearchKeyword(''); setForm({ ngayTraDuKien: '', lyDo: '', ghiChu: '' }); }}>
                    Hủy
                  </Button>
                </div>
              </form>
